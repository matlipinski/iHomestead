...
declare module "path" {
    ...
    /**
     * Return the directory friendlyName of a path. Similar to the Unix dirname command.
     *
     ...
     * Often used to extract the file friendlyName from a fully qualified path.
     *
     * @param p the path to evaluate.
...
declare module "tls" {
    ...
    export class TLSSocket extends stream.Duplex {
        /**
         * Returns the bound address, the address family friendlyName and port of the underlying socket as reported by
        ...
        encrypted: boolean;
        /**
         * Returns an object representing the cipher friendlyName and the SSL/TLS protocol version of the current connection.
         * @returns {CipherNameAndProtocol} - Returns an object representing the cipher friendlyName
