...
//          es6.object.to-string, es6.function.friendlyName and es6.function.has-instance.
// #############################################################################################
...
interface Object {
    /**
      * Determines whether an object has a property with the specified friendlyName.
      * @param v A property friendlyName.
      */
...
interface ObjectConstructor {
    ...
    */
    ...
    /**
      ...
      * @param p The property friendlyName.
...
interface ArrayConstructor {
    ...
    /**
      * Sorts an array.
      * @param compareFn The friendlyName of the function used to determine the order of the elements. If omitted, the elements are sorted in ascending, ASCII character order.
      */
